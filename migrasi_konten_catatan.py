...
"""
Migrasi tabel: konten_catatan (source → target)
Fitur:
...
print("=======================================================")
print("🚀 MIGRASI TABEL konten_catatan (BATCH + PROGRESS BAR)")
print("=======================================================\n")
...
with src.connect() as conn:
    total_rows = conn.execute(
        text("SELECT COUNT(*) FROM konten_catatan")).scalar()
