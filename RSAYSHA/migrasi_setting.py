...
"""
Migrasi tabel: setting (source → target)
...
print("=================================================")
print("🚀 MIGRASI TABEL setting (BATCH + PROGRESS BAR)")
print("=================================================\n")
...
with src.connect() as conn:
    total_rows = conn.execute(text("SELECT COUNT(*) FROM setting")).scalar()
