...
"""
Migrasi tabel: paket_antibiotik (source → target)
Fitur:
...
print("====================================================")
print("🚀 MIGRASI TABEL paket_antibiotik (BATCH + PROGRESS)")
print("====================================================\n")
...
with src.connect() as conn:
    total_rows = conn.execute(
        text("SELECT COUNT(*) FROM paket_antibiotik")).scalar()
