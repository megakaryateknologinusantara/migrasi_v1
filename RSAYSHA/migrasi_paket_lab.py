...
"""
Migrasi tabel: paket_lab (source → target)
Fitur:
...
print("================================================")
print("🚀 MIGRASI TABEL paket_lab (BATCH + PROGRESS)")
print("================================================\n")
...
# === [4] Hitung total row dari SOURCE ===
with src.connect() as conn:
    total_rows = conn.execute(text("SELECT COUNT(*) FROM paket_lab")).scalar()
