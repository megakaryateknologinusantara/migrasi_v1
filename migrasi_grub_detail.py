...
"""
Migrasi tabel: grub_detail (source → target)
...
print("=========================================")
print("🚀 MIGRASI TABEL grub_detail (BATCH MODE)")
print("=========================================\n")
...
with src.connect() as conn:
    total_rows = conn.execute(
        text("SELECT COUNT(*) FROM grub_detail")).scalar()
