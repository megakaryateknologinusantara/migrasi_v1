...
"""
Migrasi tabel: duplo_ori (source → target)
...
print("=================================================")
print("🚀 MIGRASI TABEL duplo_ori (BATCH + PROGRESS BAR)")
print("=================================================\n")
...
with src.connect() as conn:
    total_rows = conn.execute(text("SELECT COUNT(*) FROM duplo_ori")).scalar()
