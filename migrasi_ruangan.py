...
"""
Migrasi tabel: ruangan (source → target)
Fitur:
...
print("=================================================")
print("🚀 MIGRASI TABEL ruangan (BATCH + PROGRESS BAR)")
print("=================================================\n")
...
with src.connect() as conn:
    total_rows = conn.execute(text("SELECT COUNT(*) FROM ruangan")).scalar()
